...
### 5.1 Mapa 1 — Ybirá-Puera (Rio das Árvores Antigas)
...
### 5.2 Mapa 2 — Floresta de Mãe-da-Mata (zona intermediária)
...
### 5.3 Mapa 3 — Tavy-Katu ("Clareira Amaldiçoada")
...
| # | Asset | Descrição | Dificuldade | Notas |
|---|-------|-----------|-------------|-------|
| 5.4.1 | Mapa 4 — Tupã-Mbara ("Campo dos Ancestrais") | Vegetação de caatinga, solo rachado | 🟡 | Similar ao mapa 3 |
| 5.4.2 | Mapa 5 — Templo nas Nuvens | Áreas alagadas, vegetação densa | 🟡 | Similar ao mapa 1 |
| 5.4.3 | Mapa 6 — Ygara-Mbya ("Caminho das Águas Escuras" — arena de boss) | Área aquática com ilha/altar | 🔴 | Requer água + arena |

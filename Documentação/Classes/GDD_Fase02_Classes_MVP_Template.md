...
| Nível | Evolução | Foco |
|---|---|---|
| 15 | Tembira-Açu (grande) | Liderança e buffs para o grupo |
| 30 | Tembira-Poty (glorioso) | Guerreiro abençoado por Tupã, poderes de trovão e escudo divino |
...
| Nível | Evolução | Foco |
|---|---|---|
| 15 | Karaí-Porã (sábio) | Invocação e feitiços de área |
| 30 | Karaí-Mbo'epy (mestre dos espíritos) | Mestre dos elementos, acesso a trovões e tempestades |
...
| Nível | Evolução | Foco |
|---|---|---|
| 15 | Payé-Pirá (das águas sagradas) | Cura em área e buffs de resistência |
| 30 | Payé-Ará (espírito elevado) | Grande sacerdote — ressurreição, purificação em massa, bênçãos permanentes |

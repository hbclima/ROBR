...
function SpawnSystem.Init()
    -- Mapa 1 - Ybirá-Puera
    SpawnSystem.RegistrarSpawn("Mapa1_YbiráPuera", "MOB_001", 5) -- Sapo Cururu
    SpawnSystem.RegistrarSpawn("Mapa1_YbiráPuera", "MOB_015", 3) -- Capivara
    SpawnSystem.RegistrarSpawn("Mapa1_YbiráPuera", "MOB_002", 4) -- Cobra d'Agua
    ...
    -- Mapa 3 - Tavy-Katu
    SpawnSystem.RegistrarSpawn("Mapa3_TavyKatu", "MOB_004", 3) -- Boitata
    SpawnSystem.RegistrarSpawn("Mapa3_TavyKatu", "MOB_012", 2) -- Mula
    SpawnSystem.RegistrarSpawn("Mapa3_TavyKatu", "MOB_016", 2) -- Jacare

    -- Mapa 4 - Tupã-Mbara
    SpawnSystem.RegistrarSpawn("Mapa4_TupaMbara", "MOB_005", 2) -- Curupira
    SpawnSystem.RegistrarSpawn("Mapa4_TupaMbara", "MOB_008", 2) -- Anhanga
    SpawnSystem.RegistrarSpawn("Mapa4_TupaMbara", "MOB_014", 2) -- Onca
    ...
    SpawnSystem.RegistrarSpawn("Mapa6_YgaraMbya", "MOB_007", 1) -- Boiuna
end
...
function SpawnSystem.GetSpawnPosition(mapa)
    ...
    local basePositions = {
        Mapa1_YbiráPuera = Vector3.new(0, 5, 0),
        Mapa2_FlorestaMaeDaMata = Vector3.new(200, 5, 0),
        Mapa3_TavyKatu = Vector3.new(400, 5, 0),
        Mapa4_TupaMbara = Vector3.new(600, 5, 0),
        Mapa5_TemploNasNuvens = Vector3.new(800, 5, 0),
        Mapa6_YgaraMbya = Vector3.new(1000, 5, 0),
    }
...
function DataController.OnPlayerAdded(player)
    ...
    local wirai = Instance.new("IntValue")
    wirai.Name = "Wira'i"
    wirai.Value = data.wirai
    wirai.Parent = leaderstats
...
RunService.Heartbeat:Connect(function(deltaTime)
    ...
    if mobUpdateCounter >= 0.5 then -- Atualizar mobs a cada 0.5s
        ...
        for _, mob in ipairs(mobsAtivos) do
            local mapa = mob.mapa or "Mapa1_YbiráPuera"

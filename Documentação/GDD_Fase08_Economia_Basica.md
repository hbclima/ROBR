...
| Item | Preço (Wira'i) | Efeito | Nível Mínimo |
|---|---|---|---|
...
| Item | Preço (Wira'i) | Slot | Stats | Nível Mínimo |
|---|---|---|---|---|
...
Os jogadores podem vender drops de mobs para NPCs pelo valor de tabela definido nas fichas de mob (campo `valor_npc_wirai`).
...
2. Ambos colocam itens e/ou Wira'i na janela de trade
3. Ambos confirmam
...
| Máximo de Wira'i por trade | 999.999 |
...
| Nível | Wira'i Estimado (acumulado) | Fonte Principal |
|---|---|---|
| 1–5 | ~500–1.000 Wira'i | Drops de Sapo Cururu, Capivara |
| 6–10 | ~2.000–5.000 Wira'i | Drops de Cobra-d'Água, venda de equipamentos |
| 11–15 | ~8.000–15.000 Wira'i | Drops de Mãe-da-Mata, Boto |
| 16–20 | ~20.000–35.000 Wira'i | Drops de Boitatá, Mula, Jacaré |
| 21–25 | ~50.000–80.000 Wira'i | Drops de Curupira, Angá, Onça |
| 26–30 | ~100.000–150.000 Wira'i | Drops de Saci Sombrio, Jurupari, Boiúna |
...
| 21–30 | Equipamento de elite, acúmulo de Wira'i para trade |
...
- **Wira'i como limitador:** O jogador não pode comprar tudo — precisa escolher entre consumíveis, equipamentos e poupar para trade
- **Venda de drops como renda principal:** O grind de mobs é a fonte primária de Wira'i

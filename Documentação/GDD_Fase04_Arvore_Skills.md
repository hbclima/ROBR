...
| S2 | Invocação de Angakýi | Controle | 18 | 18s | — | Espírito auxiliar ataca por 8s (HP baixo, distrai) | Nível 1 |
| S3 | Maldição de Angá | Debuff | 15 | 15s | INT × 0.7 | Reduz dano do alvo 30% + vulnerável a mágico por 6s | Nível 1 |
...
| Invocação de Angakýi | +2s de duração | 5 upgrades (+10s) |
| Maldição de Angá | +5% redução de dano | 5 upgrades (+25%) |
...
| S3 | Exorcismo de Angakýi | Cura/Debuff | 15 | 20s | — | Remove 1 debuff de aliado; dano a espíritos invocados | Nível 1 |
...
| Exorcismo de Angakýi | +1s de redução de cooldown | 5 upgrades (-5s) |
...
| Exorcismo de Angakýi | 3 | Cooldown 17s |

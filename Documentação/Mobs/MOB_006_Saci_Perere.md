...
**Origem no lore:**
> O mais famoso personagem travesso do folclore brasileiro. Vive pregando peças em viajantes, sumindo em redemoinhos e escondendo objetos. Habita clareiras de bambu e vilas abandonadas, onde usa sua agilidade e magia de vento para confundir invasores.

**Habitat:**
| Campo | Valor |
|---|---|
| mapa | Mapa 5 — Zona de Transição Final |
| zona_tipo | avançada |
| periodo | ambos |
...
|---|---|---|---|---|
| ITEM_041 | Carta — Saci Pererê | especial | 0.5 | 420 |
...
- **Carta — Saci Pererê:** Equipada concede "Travessura" — 15% de chance de anular um ataque recebido (esquiva especial) e 5% de chance de duplicar o dano do próximo ataque.

...
**Origem no lore:**
> O Jaguar Sagrado, mensageiro supremo de Tupã. Guardião do Templo do Trovão no topo da Montanha Sagrada. Representa a força da natureza em sua forma mais pura e devastadora. É o boss final do MVP.

**Habitat:**
| Campo | Valor |
|---|---|
| mapa | Mapa 6 — Zona Final / Boss Arena |
| zona_tipo | final |
| periodo | ambos |
| ambiente_especifico | Templo do Trovão no topo da Montanha Sagrada |

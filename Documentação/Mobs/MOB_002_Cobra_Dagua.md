...
**Origem no lore:**
> Protetora dos rios, antecessora menor do Boitatá. Ataca caçadores que poluem ou pescam em excesso. Habita margens e pântanos, sendo uma guardiã das águas doces.

**Habitat:**
| Campo | Valor |
|---|---|
| mapa | Mapa 1–2 — Zona Inicial / Transição |
| zona_tipo | inicial |
| periodo | ambos |

...
| Restrições por classe | **Guerreiro:** armas de 2 mãos apenas (não pode usar secundária). **Mago:** cajado + escudo/livro |
...
|-----------|-----------|-----------------|---------------------|-----------|
| `EQUIP_001` | Arma leve (espada) | arma_principal | Guerreiro | ATK +15 |
| `EQUIP_002` | Arma pesada (espada 2 mãos) | arma_principal | Guerreiro | ATK +30 |
| `EQUIP_003` | Cajado | arma_principal | Mago | ATK +10, INT +2 |
| `EQUIP_004` | Escudo/Livro | — (bônus passivo) | Mago | DEF +5 |
| `EQUIP_005` | Capacete de couro | capacete | Todas | DEF +3 |
| `EQUIP_006` | Capacete de metal | capacete | Guerreiro | DEF +6 |
| `EQUIP_007` | Armadura de couro | armadura | Todas | DEF +8 |
| `EQUIP_008` | Armadura de metal | armadura | Guerreiro | DEF +15 |
| `EQUIP_009` | Botas de couro | botas | Todas | DEF +2, AGI +1 |
| `EQUIP_010` | Botas de metal | botas | Guerreiro | DEF +5 |
